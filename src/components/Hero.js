      ...
      <section className="relative bg-white py-16 md:py-24">
        ...
        <div className="relative max-w-screen-lg mx-auto px-4 md:px-6 lg:px-0">
          <div className="max-w-6xl">
            ...
            <h2
              className="mt-6 text-2xl md:text-3xl lg:text-5xl leading-tight tracking-normal"
              style={{
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3 xl:grid-cols-3">
            ...
            {/* Swap Page */}
            <article
              className="flex flex-col justify-between rounded-3xl border  bg-white/80 p-6 shadow-md backdrop-blur"
              style={{ borderColor: "#292035" }}
            >
              <div>
                <div className="flex items-center gap-4">
                  ...
                  <h3
                    className="text-1xl md:text-1xl lg:text-2xl leading-snug"
                    style={{
                      fontFamily: '"Press Start 2P", cursive',
                      color: "#292035",
                      transform: "scale(0.60, 0.90)",
                ...
                <p className="mt-6 text-base md:text-lg text-slate-700">
                  Trade $DISCO and any other Base token with a playful interface
                  built for speed, clarity, and memecoin magic.
                </p>
              </div>
              <div
                className="mt-8 flex items-center gap-2 text-sm uppercase tracking-widest "
                style={{ color: "#292035" }}
              >
            ...
            <article
             ...
             bg-white/80 p-6 shadow-md backdrop-blur"
              style={{ borderColor: "#292035" }}
            >
              <div>
                <div className="flex items-center gap-4">
                  ...
                  <h3
                    className="text-1xl md:text-1xl lg:text-2xl text-blue-800 leading-snug"
                    style={{
                      fontFamily: '"Press Start 2P", cursive',
                      color: "#292035",
                      transform: "scale(0.60, 0.90)",
